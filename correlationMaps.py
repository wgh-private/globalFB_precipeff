...
dVAR_map_o = [dLWP_g.data * pe_maps_ol.data, totdCRE_g_t * pe_maps_ol.data]
...
plt.savefig(f'{fig_dir}gPE_λcldpdPE_∆LWPpdPE_correlation.png',
            bbox_inches='tight', facecolor='white', dpi=600)




# # -------------- Plot correlation of global precipitation eff with ∆LWP and lambda in maps ----------------- 
